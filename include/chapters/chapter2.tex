...
\begin{figure}[!ht]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{assemble.pdf}
        \caption{}
        \label{fig:assemble}
    \end{subfigure}
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{flexed-assemble.pdf}
        \caption{}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth]{neutral-layer.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth]{normal-forces.pdf}
